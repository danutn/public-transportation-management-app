...
<BR>
                <div class="col-lg-9">
                  ...
                  <h4 class="cstm-family" style=" color:Green; font-size: 16x;"> &nbsp;	&nbsp;&nbsp;&nbsp;utlilizatorilor sansa de a trimite o estimatie</h4>  
                  </div>
                </div>
              </div>
<BR>
...
<ol>
<ol type="1" >
<li><p style="font-size:18px;"  class="cstm-family">Transport public local de călători cu autobuze, midibuze, troleibuze și tramvaie</p></li>
