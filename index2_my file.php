...
a:focus, a:hover {
    ...
    <title>BusApp 2018 Desktop</title>
...
$allstations=" Select distinct(Id_Statie) from programare WHERE   Zi_sapt=".$dayofweek." AND Ora>='".$currenttime."' AND Ora<='".$cenvertedTimepluson."'";
   ...
   ?>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">BusApp 2018 Desktop</a>
...
?>
   ...
   foreach($results_2 as $getlongilatitude)
   {
    ...
    $innerquery=" Select Id_Traseu,Id_Numar_Masini,Ora from programare WHERE  Id_Statie=".$allRouteBusses->Id_Statie." AND Zi_sapt=".$dayofweek." AND Ora>='".$currenttime."' AND Ora<='".$cenvertedTimepluson."'";
...
if(distance==secondMin)
{
 ...
 <!-- End Google map api Script (Integration) -->
...
<BR>
                <div class="col-lg-9">
                  <div class="functii-item">
                   <h4 class="cstm-family" style=" color:Green; font-size: 16x;"><i class="icon-camera text-primary"></i> 		Aplicatie usor de foit ce permite tuturor </h4>
...
<ol>
<ol type="1" >
<li><p style="font-size:18px;"  class="cstm-family">Transport public local de calatori cu autobuze, midibuze, troleibuze si tramvaie</p></li>
