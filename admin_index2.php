...
<html lang="en">
<?php
//include Connection File  And Check The user Session 
...
//$query=" Select Id_Statie,Id_Traseu,Id_Numar_Masini,Ora from programare WHERE  Id_Traseu IN('1','2','3','4') AND Zi_sapt=".$dayofweek." AND Ora>='".$currenttime."' AND Ora<='".$cenvertedTimepluson."'";
...
?>
     ...
     <!-- Display username And Geolocation Button -->
      <h4 style="margin-left: 67px;">Howdy, <?=$_SESSION['adminName']?>&nbsp;&nbsp;&nbsp;<img src="userAvater/<?=$profile?>" style=" width: 50px;height: 50px;border-radius: 22px;">&nbsp;&nbsp;&nbsp;<button class="btn btn-outline-success" id="btAnimate">GET GEOLOCATION</button></h4>
        <div class="row h-100">
