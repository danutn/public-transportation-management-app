...
if($_GET['Zi_sapt']==1)
 ...
 if ( isset( $_POST[ 'estimare' ] ) ) {
	...
	if ( empty( $error ) ) {
		$data_post = array(  'Id_Traseu' => $idroute,'id_Users'=>$_SESSION['Mngid'],'registration_number'=>$regnumber, 'Id_Statie' => $stationid, 'Zi_sapt'=>$_GET['Zi_sapt'], 'Ora'=>$bustime, 'Data_estimare'=>$_POST['timesas']);
...
.alert-success {
    ...
    <h2 style="color: black;">Ajuta-ne sa imbunatatim preciza informatiilor</h2>
